            ...
            <div className="event_system_main event_system_main1">
                ...
                <div className="ks-header-bar">
                    <div className="ks-header-left">
                        <h2 className="ks-title">Volume/issues</h2>
                        <div className="ks-listing-info">
                            <span>Listing Per Page</span>
                            <select className="ks-dropdown">
                                <option>50</option>
                                <option>100</option>
                            </select>
                            <span>Listing: <strong>1 to 29</strong> of 29</span>
                        </div>
                    </div>
